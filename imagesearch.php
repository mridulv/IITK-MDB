...
if(!empty($_GET['movie']))
{
	...
	$url="http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20boss.search%20where%20ck%3D%0A'dj0yJmk9YWF3ODdGNWZPYjg2JmQ9WVdrOWVsWlZNRk5KTldFbWNHbzlNVEEyTURFNU1qWXkmcz1jb25zdW1lcnNlY3JldCZ4PTUz'%20and%20secret%3D'a3d93853ba3bad8a99a175e8ffa90a702cd08cfa'%20and%20service%3D'images'%20and%20q%3D%22" . urlencode($_GET['movie']) ."%22%3B&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&format=json";
